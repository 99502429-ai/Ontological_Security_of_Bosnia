...
\begin{description}
    \item $H_1$: There are universal topics and concepts in political speech among the political elite in \ac{BiH}, regardless of party, that shape the Bosnian state identity. \label{hyp:one}
    \item $H_2$: \ac{BiH} seeks ontological security \label{hyp:two}
    \item $H_3$: Ontological security shapes the political discourse among politicians. \label{hyp:three}
\end{description}