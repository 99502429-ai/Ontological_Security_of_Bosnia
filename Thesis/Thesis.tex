...
\def \AutorDP {Bc.\ Zachary Alan Stuck}													
\def \AuthorDP {Zachary Alan Stuck} 			%here use just English characters!
\def \FirstNameDP {Zachary} 				
\def \LastNameDP {Stuck} 							
\def \Email {zastuck@gmail.com}
\def \Year {2026}
\def \Place {Prague}
\def \Subject {Price Elasticity of Gasoline Demand}
\def \Keywords {Bosnia, Ontological Security, Identity, Balkan, Machine Learning}
...
\def \Supervisor {doc. Aliaksei Kazharski, PhD.}
\def \StudyProgram {Master's in International Relations}
\def \EmailSup {aliaksei.kazharski@fsv.cuni.cz}
...
\input{03_Backmatter/04_App.tex}           			%input file
