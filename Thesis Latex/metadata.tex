...
\def\ThesisTitle{Politics, Identity, and Ontological Security in Bosnia and Herzegovina}

% Author of the thesis (you)
\def\ThesisAuthor{Zachary Alan Stuck}
...
\def\Department{Department of International Relations}
...
\def\SupervisorsDepartment{Department of Security Studies}

% Study programme (does not apply to rigorosum theses)
\def\StudyProgramme{Master in International Relations}
...
\def\ThesisKeywords{%
Bosnia\sep Ontological Security\sep Identity\sep Balkan\sep Machine Learning
}
